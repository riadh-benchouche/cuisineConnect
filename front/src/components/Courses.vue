            ...
            <DialogPanel
              ...
              <div>
                <div class="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-primary-100">
                  <CakeIcon class="h-6 w-6 text-primary-600" aria-hidden="true"/>
                </div>
                <div class="mt-3 text-center sm:mt-5">
                  <DialogTitle as="h3" class="text-base font-semibold leading-6 text-gray-900">Courses for your
                    recipe {{ props.recipeName }}
                  </DialogTitle>
                  <div class="mt-4 ml-5">
                    <div class="prose prose-sm mt-4 text-gray-500 text-start">
                      <ul role="list">
                        <li v-for="(courses, index) in props.courses" :key="index" class="mb-2 list-disc">
                          {{ courses }}
                        </li>
                      </ul>
                    </div>
